...
class Kotlin2JvmSourceSetProcessor(
    ...
    override fun doTargetSpecificProcessing() {
        ...
        if (javaTask != null) {
            val anyClassCompiledPropertyName = "anyClassesCompiled"

            if (kotlinTask.hasProperty(anyClassCompiledPropertyName)) {
                val kotlinClassesCompiled = kotlinTask.property(anyClassCompiledPropertyName) as? Boolean ?: false
                kotlinTask.setProperty(anyClassCompiledPropertyName, false)
