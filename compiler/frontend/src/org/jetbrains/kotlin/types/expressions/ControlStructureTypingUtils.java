...
public class ControlStructureTypingUtils {
    ...
    /*package*/ ResolvedCall<FunctionDescriptor> resolveSpecialConstructionAsCall(
        ...
        TypeSubstitutor knownTypeParameterSubstitutor = createKnownTypeParameterSubstitutorForSpecialCall(function, context.expectedType);
    ...
    private static @Nullable TypeSubstitutor createKnownTypeParameterSubstitutorForSpecialCall(
        ...
        if (TypeUtils.noExpectedType(expectedType) || TypeUtils.isDontCarePlaceholder(expectedType) || KotlinBuiltIns.isUnitOrNullableUnit(expectedType)) {
            return null;
        }
